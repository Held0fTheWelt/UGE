...
#include "Pawns/SKM_SubmarinePawn.h"
...
ASKM_SubmarinePawn::ASKM_SubmarinePawn(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASKM_SubmarinePawn::GetSceneComponent_Implementation(const FName& ComponentName) const
{
