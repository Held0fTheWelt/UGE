...
ASM_ShipPawn::ASM_ShipPawn(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASM_ShipPawn::GetSceneComponent_Implementation(const FName& ComponentName) const
{
