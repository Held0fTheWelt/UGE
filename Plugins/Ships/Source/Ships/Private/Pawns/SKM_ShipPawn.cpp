...
ASKM_ShipPawn::ASKM_ShipPawn(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASKM_ShipPawn::GetSceneComponent_Implementation(const FName& ComponentName) const
{
