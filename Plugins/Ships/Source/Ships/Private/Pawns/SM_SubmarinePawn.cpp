...
#include "Pawns/SM_SubmarinePawn.h"
...
ASM_SubmarinePawn::ASM_SubmarinePawn(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASM_SubmarinePawn::GetSceneComponent_Implementation(const FName& ComponentName) const
{
