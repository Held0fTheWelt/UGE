...
#include "Actors/SM_ShipActor.h"

#include "Components/AudioComponent.h"
#include "Components/StaticMeshComponent.h"

ASM_ShipActor::ASM_ShipActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASM_ShipActor::GetSceneComponent_Implementation(const FName& ComponentName) const
{
