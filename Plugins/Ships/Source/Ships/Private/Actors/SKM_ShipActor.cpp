...
#include "Actors/SKM_ShipActor.h"
...
ASKM_ShipActor::ASKM_ShipActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASKM_ShipActor::GetSceneComponent_Implementation(const FName& ComponentName) const
{
