...
#include "Actors/SKM_SubmarineActor.h"
...
ASKM_SubmarineActor::ASKM_SubmarineActor(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASKM_SubmarineActor::GetSceneComponent_Implementation(const FName& ComponentName) const
{
