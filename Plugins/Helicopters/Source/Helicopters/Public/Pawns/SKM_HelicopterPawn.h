...
#include "SKM_HelicopterPawn.generated.h"


DECLARE_LOG_CATEGORY_EXTERN(Log_SKMHelicopterPawn, Log, All);

/**
 * 
 */
UCLASS()
class HELICOPTERS_API ASKM_HelicopterPawn : public AHelicopterPawn
{
	GENERATED_BODY()
