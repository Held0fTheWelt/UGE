...
#include "PlayerStart_Base.generated.h"
 ...
 */
UCLASS(Config = Game)
class ELEMENTAL_CLASSES_API APlayerStart_Base : public APlayerStart
{
	GENERATED_BODY()

public:
	APlayerStart_Base(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
