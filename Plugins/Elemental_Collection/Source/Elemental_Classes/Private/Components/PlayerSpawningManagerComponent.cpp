...
#include "Components/PlayerSpawningManagerComponent.h"
...
// APlayerStart_Base Proxied Calls - Need to handle when someone chooses
...
void UPlayerSpawningManagerComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
}

APlayerStart* UPlayerSpawningManagerComponent::GetFirstRandomUnoccupiedPlayerStart(AController* Controller, const TArray<APlayerStart_Base*>& StartPoints) const
{
	if (Controller)
	{
