...
#include "ElementalChaosVehicleSetupDataAsset.generated.h"

/**
 * Elemental vehicle setup data asset (PreLoading). Named to avoid UHT conflict with Vehicles plugin's ChaosVehicleSetupDataAsset.h.
 */
UCLASS()
class ELEMENTAL_DATA_API UElementalChaosVehicleSetupDataAsset : public UPreLoadingDataAsset
{
	GENERATED_BODY()

public:
	UElementalChaosVehicleSetupDataAsset(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get())
