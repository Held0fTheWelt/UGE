...
#include "NotificationMessage.generated.h"

class UObject;

ELEMENTAL_MESSAGESYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AddNotification_Message);

class APlayerState;

// A message destined for a transient log (e.g., an elimination feed or inventory pickup stream)
USTRUCT(BlueprintType)
struct ELEMENTAL_MESSAGESYSTEM_API FNotificationMessage
{
	GENERATED_BODY()
