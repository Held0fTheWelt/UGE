...
public:
	...
	ELEMENTAL_MESSAGESYSTEM_API virtual void BeginPlay() override;
	ELEMENTAL_MESSAGESYSTEM_API virtual void EndPlay(const EEndPlayReason::Type EndPlayReason) override;
	//~End of UActorComponent interface

	ELEMENTAL_MESSAGESYSTEM_API virtual void StartListening();
	ELEMENTAL_MESSAGESYSTEM_API virtual void StopListening();

protected:
	ELEMENTAL_MESSAGESYSTEM_API void AddListenerHandle(FGameplayMessageListenerHandle&& Handle);
	ELEMENTAL_MESSAGESYSTEM_API double GetServerTime() const;
