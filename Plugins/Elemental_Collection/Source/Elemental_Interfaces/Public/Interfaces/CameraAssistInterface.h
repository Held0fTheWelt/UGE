 ...
 * 
 */
class ELEMENTAL_INTERFACES_API ICameraAssistInterface
{
	GENERATED_BODY()
...
public:
	 ...
	 * a vehicle..etc.
	 */
	virtual void GetIgnoredActorsForCameraPentration(TArray<const class AActor*>& OutActorsAllowPenetration) const {}
	 ...
	 */
	virtual TOptional<class AActor*> GetCameraPreventPenetrationTarget() const
	{
