 ...
 */
UCLASS()
class ELEMENTAL_COMMON_API UAsyncAction_ShowConfirmation : public UBlueprintAsyncActionBase
{
...
public:
	...
	static UAsyncAction_ShowConfirmation* ShowConfirmationCustom(
		UObject* InWorldContextObject, class UCommonGameDialogDescriptor* Descriptor
	);
