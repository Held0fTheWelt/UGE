...
#include "ElementalSettings_Shared.generated.h"
...
/**
 * UElementalSettings_Shared - The "Shared" settings are stored as part of the USaveGame system, these settings are not machine
 ...
 */
UCLASS()
class ELEMENTAL_SETTINGS_API UElementalSettings_Shared : public ULocalPlayerSaveGame
{
	GENERATED_BODY()
//	
//public:
//	DECLARE_EVENT_OneParam(UElementalSettings_Shared, FOnSettingChangedEvent, UElementalSettings_Shared* Settings);
//	FOnSettingChangedEvent OnSettingChanged;
//
//public:
//
//	UElementalSettings_Shared();
//
...
//	//static UElementalSettings_Shared* CreateTemporarySettings(const ULyraLocalPlayer* LocalPlayer);
//
//	/** Synchronously loads a settings object, this is not valid to call before login */
//	//static UElementalSettings_Shared* LoadOrCreateSettings(const ULyraLocalPlayer* LocalPlayer);
//
//	DECLARE_DELEGATE_OneParam(FOnSettingsLoadedEvent, UElementalSettings_Shared* Settings);
//
