...
// Adapted for WarCollection – lives in Elemental_Structure so Teams/Inventory/Core can use it without depending on Elemental_Player.
...
struct ELEMENTAL_STRUCTURE_API FGameplayTagStack : public FFastArraySerializerItem
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ELEMENTAL_STRUCTURE_API FGameplayTagStackContainer : public FFastArraySerializer
{
	GENERATED_BODY()
