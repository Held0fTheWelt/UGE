...
#include "MeshCollectionItem.generated.h"
...
public:
	...
	EMeshComponentType ComponentType = EMeshComponentType::MCT_NONE;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Variable)
	FName ComponentName;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Transform)
	FTransform ComponentTransform;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = StaticMesh)
	TSoftObjectPtr<class UStreamableRenderAsset> ComponentMesh;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Physics, meta = (EditCondition = "ComponentType == EMeshComponentType::MCT_MESH_SKELETAL"))
	TSoftObjectPtr<class UPhysicsAsset> PhysicsAssetOverride = nullptr;
