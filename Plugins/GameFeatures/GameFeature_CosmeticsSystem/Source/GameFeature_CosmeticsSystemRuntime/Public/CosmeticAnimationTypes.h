...
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCosmeticAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCosmeticAnimLayerSelectionSet
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCosmeticAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCosmeticAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
