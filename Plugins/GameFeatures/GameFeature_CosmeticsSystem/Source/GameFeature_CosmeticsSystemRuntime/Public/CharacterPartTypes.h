...
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCharacterPartHandle
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GAMEFEATURE_COSMETICSSYSTEMRUNTIME_API FCharacterPart
{
	GENERATED_BODY()
	...
	static bool AreEquivalentParts(const FCharacterPart& A, const FCharacterPart& B)
	{
