...
#include "PawnComponent_CharacterParts.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PawnComponent_CharacterParts)
...
UPawnComponent_CharacterParts::UPawnComponent_CharacterParts(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	SetIsReplicatedByDefault(true);
}

void UPawnComponent_CharacterParts::GetLifetimeReplicatedProps(TArray< FLifetimeProperty >& OutLifetimeProps) const
{
...
FCharacterPartHandle UPawnComponent_CharacterParts::AddCharacterPart(const FCharacterPart& NewPart)
{
	return CharacterPartList.AddEntry(NewPart);
}

void UPawnComponent_CharacterParts::RemoveCharacterPart(FCharacterPartHandle Handle)
{
	CharacterPartList.RemoveEntry(Handle);
}

void UPawnComponent_CharacterParts::RemoveAllCharacterParts()
{
	CharacterPartList.ClearAllEntries(/*bBroadcastChangeDelegate=*/ true);
}

void UPawnComponent_CharacterParts::BeginPlay()
{
	Super::BeginPlay();
}

void UPawnComponent_CharacterParts::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void UPawnComponent_CharacterParts::OnRegister()
{
	Super::OnRegister();
...
TArray<AActor*> UPawnComponent_CharacterParts::GetCharacterPartActors() const
{
...
USkeletalMeshComponent* UPawnComponent_CharacterParts::GetParentMeshComponent() const
{
...
USceneComponent* UPawnComponent_CharacterParts::GetSceneComponentToAttachTo() const
{
...
FGameplayTagContainer UPawnComponent_CharacterParts::GetCombinedTags(FGameplayTag RequiredPrefix) const
{
...
void UPawnComponent_CharacterParts::BroadcastChanged()
{
