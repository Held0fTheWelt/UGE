...
#include "CorePlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CorePlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "CoreCheats"

UCorePlatformEmulationSettings::UCorePlatformEmulationSettings()
{
}

FName UCorePlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UCorePlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UCorePlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UCorePlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UCorePlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UCorePlatformEmulationSettings::PostInitProperties()
{
...
void UCorePlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UCorePlatformEmulationSettings::ApplySettings()
{
...
void UCorePlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UCorePlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UCorePlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UCorePlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
