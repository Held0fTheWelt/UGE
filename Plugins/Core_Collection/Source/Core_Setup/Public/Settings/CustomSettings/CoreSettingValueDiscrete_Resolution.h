...
#include "CoreSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class CORE_SETUP_API UCoreSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UCoreSettingValueDiscrete_Resolution();
