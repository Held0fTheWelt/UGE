...
#include "CoreSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class CORE_SETUP_API UCoreSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UCoreSettingValueDiscreteDynamic_AudioOutputDevice() = default;
