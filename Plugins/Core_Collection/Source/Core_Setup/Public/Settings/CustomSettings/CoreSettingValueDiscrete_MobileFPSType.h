...
#include "CoreSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class CORE_SETUP_API UCoreSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UCoreSettingValueDiscrete_MobileFPSType();
