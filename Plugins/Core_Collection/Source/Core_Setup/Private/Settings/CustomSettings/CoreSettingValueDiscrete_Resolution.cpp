...
#include "Settings/CustomSettings/CoreSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "CoreSettings"

UCoreSettingValueDiscrete_Resolution::UCoreSettingValueDiscrete_Resolution()
{
}

void UCoreSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UCoreSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UCoreSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UCoreSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UCoreSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UCoreSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UCoreSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UCoreSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UCoreSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UCoreSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UCoreSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UCoreSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UCoreSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UCoreSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UCoreSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UCoreSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
