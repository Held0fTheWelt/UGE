...
#include "CoreGameFeaturePolicy.generated.h"
...
class UCoreGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	static UCoreGameFeaturePolicy& Get();

	UCoreGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
