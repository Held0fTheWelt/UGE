...
#include "Libs/ActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(ActorUtilities)

EBlueprintExposedNetMode UActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
