...
#include "CoreGamePhaseAbility.generated.h"

/**
 * UCoreGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class CORE_ABILITYSYSTEM_API UCoreGamePhaseAbility : public UCoreGameplayAbility
{
	GENERATED_BODY()

public:

	UCoreGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Core|Game Phase")
