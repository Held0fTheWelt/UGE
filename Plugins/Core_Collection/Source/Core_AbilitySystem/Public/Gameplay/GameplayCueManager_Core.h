...
#include "GameplayCueManager_Core.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(Log_AbilitySystem_CueManager, Log, All);

/**
 * UGameplayCueManager_Core
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class CORE_ABILITYSYSTEM_API UGameplayCueManager_Core : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UGameplayCueManager_Core(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UGameplayCueManager_Core* Get();
