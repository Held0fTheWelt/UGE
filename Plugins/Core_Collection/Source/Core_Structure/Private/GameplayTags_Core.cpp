...
// GameplayTags_Core – in Core_Structure (migrated from Core_GameplayTags)
...
namespace GameplayTags_Core
{
	...
	// When extending Core, you can create your own movement modes but you need to update CustomMovementModeTagMap
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Movement_Mode_Custom, "Movement.Mode.Custom", "This is invalid and should be replaced with custom tags.  See GameplayTags_Core::CustomMovementModeTagMap.");

	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Gameplay_MovementStopped, "Gameplay.MovementStopped", "Movement is stopped (e.g., by an ability).");
