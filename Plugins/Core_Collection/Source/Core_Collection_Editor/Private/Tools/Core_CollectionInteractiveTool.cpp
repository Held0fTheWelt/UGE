...
#include "Core_CollectionInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCore_CollectionInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCore_CollectionInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCore_CollectionInteractiveTool* NewTool = NewObject<UCore_CollectionInteractiveTool>(SceneState.ToolManager);
...
UCore_CollectionInteractiveToolProperties::UCore_CollectionInteractiveToolProperties()
{
...
void UCore_CollectionInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCore_CollectionInteractiveTool::Setup()
{
	...
	Properties = NewObject<UCore_CollectionInteractiveToolProperties>(this, "Measurement");
...
void UCore_CollectionInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCore_CollectionInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCore_CollectionInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCore_CollectionInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCore_CollectionInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCore_CollectionInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCore_CollectionInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCore_CollectionInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCore_CollectionInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
