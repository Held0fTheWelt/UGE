...
#include "Core_CollectionInteractiveTool.generated.h"


/**
 * Builder for UCore_CollectionInteractiveTool
 */
UCLASS()
class CORE_COLLECTION_EDITOR_API UCore_CollectionInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCore_CollectionInteractiveTool
 */
UCLASS(Transient)
class CORE_COLLECTION_EDITOR_API UCore_CollectionInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCore_CollectionInteractiveToolProperties();
...
/**
 * UCore_CollectionInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class CORE_COLLECTION_EDITOR_API UCore_CollectionInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCore_CollectionInteractiveToolProperties> Properties;
