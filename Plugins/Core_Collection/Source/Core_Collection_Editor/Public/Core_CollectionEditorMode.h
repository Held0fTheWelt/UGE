...
#include "Core_CollectionEditorMode.generated.h"
 ...
 */
UCLASS()
class UCore_CollectionEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_Core_CollectionEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCore_CollectionEditorMode();
	virtual ~UCore_CollectionEditorMode();
