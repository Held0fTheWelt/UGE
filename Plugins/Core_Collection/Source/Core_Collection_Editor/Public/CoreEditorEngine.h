...
#include "CoreEditorEngine.generated.h"
...
UCLASS()
class CORE_COLLECTION_EDITOR_API UCoreEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	UCoreEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
