...
class CORE_COLLECTION_EDITOR_API FCoreValidationMessageGatherer : public FOutputDevice
{
public:
	FCoreValidationMessageGatherer()
		: FOutputDevice()
	{
		GLog->AddOutputDevice(this);
	}

	virtual ~FCoreValidationMessageGatherer()
	{
...
UCLASS(Abstract)
class CORE_COLLECTION_EDITOR_API UEditorValidator : public UEditorValidatorBase
{
	GENERATED_BODY()
