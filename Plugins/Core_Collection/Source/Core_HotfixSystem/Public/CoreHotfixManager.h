...
UCLASS()
class CORE_HOTFIXSYSTEM_API UCoreHotfixManager : public UOnlineHotfixManager
{
	GENERATED_BODY()
...
public:
	...
	CORE_HOTFIXSYSTEM_API UCoreHotfixManager();
	CORE_HOTFIXSYSTEM_API virtual ~UCoreHotfixManager();
