...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreHotfixManager)

int32 UCoreHotfixManager::GameHotfixCounter = 0;

UCoreHotfixManager::UCoreHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UCoreHotfixManager::GetOnScreenMessages);
...
void UCoreHotfixManager::Init()
{
	Super::Init();
}

void UCoreHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UCoreSettingsLocal* GameSettings = UCoreSettingsLocal::Get();
		if (GameSettings)
		{
...
bool UCoreHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UCoreHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UCoreHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UCoreHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UCoreHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UCoreHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UCoreHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UCoreHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UCoreHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
