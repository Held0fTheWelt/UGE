...
#include "CoreTaggedWidget.generated.h"
 ...
 * Adapted from ULyraTaggedWidget.
 */
UCLASS(Abstract, Blueprintable)
class CORE_CLASSES_API UCoreTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UCoreTaggedWidget(const FObjectInitializer& ObjectInitializer);
