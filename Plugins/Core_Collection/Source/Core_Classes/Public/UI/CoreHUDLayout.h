...
#include "CoreHUDLayout.generated.h"

class UCommonActivatableWidget;
class UObject;
class UCoreControllerDisconnectedScreen;

/**
 * UCoreHUDLayout
 *
 * Widget used to lay out the player's HUD (typically specified by an Add Widgets action in the experience).
 * Adapted from ULyraHUDLayout.
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "Core HUD Layout", Category = "Core|HUD"))
class CORE_CLASSES_API UCoreHUDLayout : public UCoreActivatableWidget
{
	GENERATED_BODY()

public:

	UCoreHUDLayout(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	*/
	...
	TSubclassOf<UCoreControllerDisconnectedScreen> ControllerDisconnectedScreen;
