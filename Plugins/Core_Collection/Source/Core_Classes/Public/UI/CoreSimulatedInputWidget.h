...
#include "CoreSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Core Simulated Input Widget" ))
class CORE_CLASSES_API UCoreSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
UCoreSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
