...
#include "CoreBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class CORE_CLASSES_API UCoreBrightnessEditor : public UCoreActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UCoreBrightnessEditor(const FObjectInitializer& Initializer);
