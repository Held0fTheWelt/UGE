...
#include "CoreSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class CORE_CLASSES_API UCoreSafeZoneEditor : public UCoreActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UCoreSafeZoneEditor(const FObjectInitializer& Initializer);
