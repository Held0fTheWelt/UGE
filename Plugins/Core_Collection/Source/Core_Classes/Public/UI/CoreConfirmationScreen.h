...
#include "CoreConfirmationScreen.generated.h"
...
/**
 * UCoreConfirmationScreen
 *
 * Confirmation dialog screen.
 * Adapted from ULyraConfirmationScreen.
 */
UCLASS(Abstract, BlueprintType, Blueprintable)
class CORE_CLASSES_API UCoreConfirmationScreen : public UCommonGameDialog
{
	GENERATED_BODY()
public:
