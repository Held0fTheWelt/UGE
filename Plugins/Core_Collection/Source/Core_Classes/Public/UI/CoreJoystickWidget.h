...
#include "CoreJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="Core Joystick" ))
class CORE_CLASSES_API UCoreJoystickWidget : public UCoreSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UCoreJoystickWidget(const FObjectInitializer& ObjectInitializer);
