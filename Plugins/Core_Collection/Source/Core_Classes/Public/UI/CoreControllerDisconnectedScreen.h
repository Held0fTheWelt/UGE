...
#include "CoreControllerDisconnectedScreen.generated.h"
...
/**
 * UCoreControllerDisconnectedScreen
 *
 ...
 * Adapted from ULyraControllerDisconnectedScreen.
 */
UCLASS(Abstract, BlueprintType, Blueprintable)
class CORE_CLASSES_API UCoreControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UCoreControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
