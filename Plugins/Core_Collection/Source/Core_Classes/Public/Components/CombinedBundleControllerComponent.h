...
#include "CombinedBundleControllerComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class CORE_CLASSES_API UCombinedBundleControllerComponent : public UControllerComponent, public IAssetDefinitionInformationInterface,
	public IEntityCoreInformationInterface
{
	GENERATED_BODY()
public:
	UCombinedBundleControllerComponent(const FObjectInitializer& ObjectInitializer);
