...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreActionWidget)

FSlateBrush UCoreActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UCoreActionWidget::GetEnhancedInputSubsystem() const
{
