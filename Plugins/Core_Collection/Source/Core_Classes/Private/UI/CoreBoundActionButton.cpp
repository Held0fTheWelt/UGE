...
#include "UI/CoreBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreBoundActionButton)

class UCommonButtonStyle;

void UCoreBoundActionButton::NativeConstruct()
{
...
void UCoreBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
