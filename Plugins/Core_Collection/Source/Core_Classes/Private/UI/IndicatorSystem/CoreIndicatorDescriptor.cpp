...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreIndicatorDescriptor)

bool FIndicatorProjection::Project(const UCoreIndicatorDescriptor& IndicatorDescriptor, const FSceneViewProjectionData& InProjectionData, const FVector2f& ScreenSize, FVector& OutScreenPositionWithDepth)
{
...
void UCoreIndicatorDescriptor::SetIndicatorManagerComponent(UCoreIndicatorManagerComponent* InManager)
{
...
void UCoreIndicatorDescriptor::UnregisterIndicator()
{
	if (UCoreIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
