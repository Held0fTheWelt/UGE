...
#include "UI/CoreWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreWidgetFactory_Class)

TSubclassOf<UUserWidget> UCoreWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
