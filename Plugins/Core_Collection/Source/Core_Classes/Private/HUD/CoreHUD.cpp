...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CoreHUD)
...
void ACoreHUD::PreInitializeComponents()
{
...
void ACoreHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void ACoreHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
