...
#include "Pawns/SKM_AircraftPawn.h"
#include "Components/AudioComponent.h"
#include "Components/SceneComponent.h"
#include "Components/ArrowComponent.h"
#include "Components/SkeletalMeshComponent.h"

ASKM_AircraftPawn::ASKM_AircraftPawn(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
USceneComponent* ASKM_AircraftPawn::GetSceneComponent_Implementation(const FName& ComponentName) const
{
